...
const Directores = () => {
  ...
  const handleCreate = async (payload) => {
    try {
      ...
      setEditingId(null);
      setForm({ nombre:"", apellido:"", email:"", telefono:"", ci:"", idFacultad:"", idCarrera:"", materiaIds:[], password: "", confirmPassword: "" });
      setFormErrors({});
    }
  };
      ...
      <ModalOverlay>
        <ModalContent size="large">
          <ModalHeader>
            ...
            <ActionButton color={ColorsLogin.secondary100} onClick={() => { setIsModalOpen(false); setEditingId(null); setForm({ nombre:"", apellido:"", email:"", telefono:"", ci:"", idFacultad:"", idCarrera:"", materiaIds:[], password: "", confirmPassword: "" }); setFormErrors({}); }}>
              <X />
            </ActionButton>
          </ModalHeader>
          ...
          <Form columns={2} onSubmit={onSubmit}>
            ...
            <ButtonGroup>
              <Button type="button" className="secondary" onClick={() => { setIsModalOpen(false); setEditingId(null); setForm({ nombre:"", apellido:"", email:"", telefono:"", ci:"", idFacultad:"", idCarrera:"", materiaIds:[], password: "", confirmPassword: "" }); setFormErrors({}); }}>
                Cancelar
              </Button>
