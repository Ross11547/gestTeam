...
import { Acciones } from "../../../style/estudiante/styledNotificacion";
...
const Inicio = () => {
  ...
  return (
    <Container>
      <CardHeader title="Proyectos Destacados">
        <Acciones>
          ...
          ?.proyectos.map((proyecto) => (
            ...
            >
              ...
              <ProyectoContent>
                ...
                <InfoGrid>
                  <InfoBox ColorsMed={ColorsMed} type="materia" >
                    <h3>
          ...
          <>
            ...
            <DetailSection>
              ...
              <InfoRow>
                <BookOpen
                  size={18}
                  style={{ marginRight: 10, color: `${ColorsMed.primary}` }}
                />
                <span>
